...
### Misc
- To display an image you will always need to use 'ImagePrefix' in the web front end which comes from the Configuration["ImagePrefix"] which is @inject IConfiguration Configuration